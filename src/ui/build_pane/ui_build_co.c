...
int	build_pane_co(void *rt, t_uipane *current)
{
	...
	if (add_btn(setb(&o->color.r, -step, pt(106, 92), BTNSZ), i) ||
		...
		add_btn(setb(&o->shine, -STEP_SH, pt(106, 392), BTNSZ), i) ||
		// add_btn(setb(&o->reflect, -STEP_RF, pt(106, 422}, BTNSZ), i) ||
		...
		add_btn(setb(&o->shine, STEP_SH, pt(136, 392), BTNSZ), i))// ||
		// add_btn(setb(&o->reflect, STEP_RF, pt(136, 422}, BTNSZ), i))
		return (1);
	return (0);
}