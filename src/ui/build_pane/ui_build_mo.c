...
int	build_pane_mo(void *rt, t_uipane *current)
{
	...
	if (add_btn(setb((t_btn_data){&o->color.r, -STEP_COL, VEC0, UIT_COL_BTN}, pt(106, 92), BTNSZ), current) ||
		...
		add_btn(setb((t_btn_data){&o->max, -STEP_HEI, VEC0, UIT_SCL_BTN}, pt(106, 392), BTNSZ), current) ||
		...
		add_btn(setb((t_btn_data){&o->max, STEP_HEI, VEC0, UIT_SCL_BTN}, pt(136, 392), BTNSZ), current) ||
