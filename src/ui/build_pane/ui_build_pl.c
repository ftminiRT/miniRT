...
int	build_pane_pl(void *rt, t_uipane *current)
{
	...
	if (add_btn(setb((t_btn_data){&o->color.r, -STEP_COL, VEC0, UIT_COL_BTN}, pt(106, 92), BTNSZ), current) ||
		...
		add_btn(setb((t_btn_data){&o->shine, -STEP_SH, VEC0, UIT_SCL_BTN}, pt(106, 362), BTNSZ), current) ||
		add_btn(setb((t_btn_data){&o->reflect, -STEP_RF, VEC0, UIT_01_BTN}, pt(106, 392), BTNSZ), current) ||
		...
		add_btn(setb((t_btn_data){&o->shine, STEP_SH, VEC0, UIT_SCL_BTN}, pt(136, 362), BTNSZ), current) ||
		add_btn(setb((t_btn_data){&o->reflect, STEP_RF, VEC0, UIT_01_BTN}, pt(136, 392), BTNSZ), current))
		return (1);
	return (0);
}
