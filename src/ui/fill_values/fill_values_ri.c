...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025-09-20 16:14:22 by tcoeffet          #+#    #+#             */
/*   Updated: 2025-09-20 16:14:22 by tcoeffet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	fill_values_ri(void *rt, t_uipane *cur)
{
	...
	putnbr_ui((t_env *)rt, 157, 422, o->scal3);
	putnbr_ui((t_env *)rt, 157, 452, o->shine);
	putnbr_ui((t_env *)rt, 157, 482, o->reflect);
	return (0);
}
